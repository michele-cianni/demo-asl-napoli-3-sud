...
const PageReferti = () => {
  ...
  return (
    <div
      data-screen-label="04 Ritiro referti online"
    ...
    >
      ...
      <div style={{ background: "var(--bi-surface)", padding: "40px 0 32px" }}>
        <div className="container">
          ...
          >
            Scarica in autonomia i referti dei tuoi esami tramite il Fascicolo
            Sanitario Elettronico della Regione Campania, senza recarti
            fisicamente in ASL.
          </p>
          ...
          >
            <div>
              <div style={{ fontWeight: 700, fontSize: 19, color: "#fff", marginBottom: 6 }}>
                Accedi al Fascicolo Sanitario Elettronico
              </div>
              <div style={{ fontSize: 15, color: "rgba(255,255,255,0.8)", lineHeight: 1.5 }}>
                Scegli il metodo di autenticazione — i tuoi referti saranno disponibili subito dopo l'accesso.
              </div>
            </div>
            ...
            <div style={{ fontSize: 12, color: "rgba(255,255,255,0.6)", borderTop: "1px solid rgba(255,255,255,0.2)", paddingTop: 14 }}>
      ...
      <Section bg="var(--bi-surface)" pad="0 0 48px">
        <div>
          ...
          <div style={{ marginBottom: 40, marginTop: 40 }}>
            ...
            >
              <li>
                Assistiti SSN iscritti all'ASL Napoli 3 Sud con Fascicolo
                Sanitario Elettronico attivo
              </li>
              <li>
                Caregiver con delega attiva per scaricare referti di un
                familiare
              </li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            >
              I tempi sono indicativi e calcolati dalla data di esecuzione della
              prestazione. Nei periodi di elevata attività possono subire
              variazioni.
            </p>
            <table
              style={{
            ...
            >
              <thead>
                <tr style={{ background: "var(--bi-primary-050)" }}>
                  {["Tipologia di esame", "Disponibile online entro"].map(
                    (h) => (
                      <th
                        key={h}
                        style={{
          ...
          >
            ...
            >
              <Icon name="info" size={22} color="var(--bi-warm)" /> Problemi di
              accesso o referto non trovato?
            </h2>
            <ul
              style={{
                paddingLeft: 20,
            ...
            >
              <li>
                Verifica che il tuo SPID/CIE sia attivo e al livello corretto
                (L2).
              </li>
              <li>
                Controlla i tempi di pubblicazione nella tabella qui sopra: il
                referto potrebbe non essere ancora disponibile.
              </li>
              <li>
                Se il portale FSE è irraggiungibile, attendi qualche minuto e
                riprova.
              </li>
              <li>
              ...
              <li>
                Per problemi tecnici al portale regionale: numero verde{" "}
                <strong>800 012 333</strong> (gratuito).
              </li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            >
              Se sei caregiver o genitore di un minore, puoi essere delegato a
              scaricare i referti di un familiare. La delega si attiva tramite
              il portale FSE Campania o presentandosi allo sportello con
              documento di identità e modulo di delega.
            </p>
            <a
              href="#"
              style={{
            ...
            >
              Scarica il modulo di delega (PDF){" "}
          ...
          >
            ...
            >
              Se non disponi di strumenti digitali, puoi ritirare il referto
              direttamente allo sportello del presidio dove hai effettuato
              l'esame.
            </p>
            <div
              style={{
          ...
          >
            ...
            <div>
              ...
              >
                I dati dei referti sono trattati ai sensi del Reg. UE 2016/679
                (GDPR) e del D.Lgs. 196/2003. L'accesso avviene in modo sicuro
                tramite autenticazione forte (SPID/CIE/CNS).{" "}
                <a
                  href="#"
          ...
          >
            ...
            <div>
              ...
              >
                <div>
                  <strong>URP ASL Napoli 3 Sud</strong> — 081 8722111 — Lun–Ven
                  9:00–13:00 | Mar–Gio 15:00–17:00
                </div>
                <div>
                  <strong>Email:</strong> urp@aslnapoli3sud.it
                </div>
                <div>
                  <strong>Supporto portale regionale:</strong> 800 012 333
                  (gratuito)
                </div>
              </div>
            </div>
...
window.PageReferti = PageReferti;

// ─── Alert banner (avviso in primo piano) ───
const AlertBar = () => (
  <div style={{
    background: "var(--bi-warm-100)",
    borderBottom: "1px solid rgba(209,73,0,0.18)",
    ...
    <div className="container" style={{
      ...
      <span style={{
        ...
        background: "var(--bi-warm)", color: "#fff", flexShrink: 0,
      }}>
        <Icon name="alert" size={16} />
      </span>
      <div style={{ flex: 1 }}>
        <strong>Campagna vaccinale 2026</strong> — aperte le prenotazioni antinfluenzali per over 60 e categorie a rischio presso tutti i distretti sanitari.{" "}
        <a href="#" style={{ color: "var(--bi-warm)", fontWeight: 700, borderBottom: "1px solid currentColor" }}>
          Prenota il tuo appuntamento
        </a>
      </div>
      <button style={{
        color: "var(--bi-ink-500)", display: "flex", alignItems: "center",
...
const Hero = () => {
  ...
  const suggestions = [
    { label: "Prenotare una visita specialistica", icon: "calendar", cat: "Servizio" },
    { label: "Ritirare un referto online", icon: "document", cat: "Servizio" },
    { label: "Cambio medico di base", icon: "users", cat: "Come fare per" },
    { label: "Esenzione ticket per reddito", icon: "document", cat: "Come fare per" },
    { label: "Distretto sanitario di Torre del Greco", icon: "hospital", cat: "Struttura" },
  ];

  const quick = ["Liste d'attesa", "CUP online", "Cambio medico", "Referti online", "Screening", "Vaccinazioni"];
  ...
  return (
    <section style={{
      ...
      <div aria-hidden style={{
        position: "absolute", top: 120, right: "38%",
        width: 1, height: 260, background: "linear-gradient(to bottom, transparent, var(--bi-primary-100), transparent)",
      }} />

      <div className="container" style={{ position: "relative", display: "grid", gridTemplateColumns: "1.15fr 1fr", gap: 72, alignItems: "center" }}>
        {/* left — search & message */}
        <div className="animate-in">
          ...
          <p style={{
            ...
            color: "var(--bi-ink-700)", marginBottom: 32,
            maxWidth: 560,
          }}>
            Prenota prestazioni, scarica referti, trova il presidio più vicino. Cerca un servizio o scopri come fare per.
          </p>
          ...
          <div style={{
            background: "#fff",
            borderRadius: 12,
            boxShadow: focused ? "0 0 0 4px rgba(0,102,204,0.15), var(--shadow-lg)" : "var(--shadow-md)",
            ...
            <div style={{ display: "flex", alignItems: "center", padding: "6px 6px 6px 20px", gap: 12 }}>
              ...
              <input
                ...
                style={{
                  ...
                  fontFamily: "var(--ff-sans)", fontSize: 17,
              ...
              <Button variant="primary" iconRight="arrow-right" size="md">Cerca</Button>
            </div>
            ...
            {focused && (
              <div style={{
                ...
                <div style={{
                  ...
                  color: "var(--bi-ink-500)", textTransform: "uppercase",
                  padding: "8px 12px",
                }}>
                ...
                {filtered.map((s, i) => (
                  <a key={i} href="#" style={{
                    ...
                    color: "var(--bi-ink-900)", fontSize: 15,
                  }}
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 20 }}>
            <span style={{ fontSize: 13, color: "var(--bi-ink-500)", alignSelf: "center", marginRight: 4 }}>
              Ricerca rapida:
            </span>
            {quick.map(q => (
              <a key={q} href="#" style={{
  ...
  <div style={{ position: "relative", minHeight: 480 }}>
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
        <span style={{
          width: 32, height: 32, borderRadius: 8,
          background: "var(--bi-primary-100)", color: "var(--bi-primary)",
          display: "flex", alignItems: "center", justifyContent: "center",
        }}>
          <Icon name="calendar" size={16} />
        </span>
        <div style={{ fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5, color: "var(--bi-ink-500)" }}>
          Prossima visita
        </div>
      </div>
      <div style={{ fontFamily: "var(--ff-serif)", fontSize: 20, fontWeight: 500, color: "var(--bi-ink-900)", marginBottom: 6 }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 11, color: "var(--bi-ink-500)", textTransform: "uppercase", letterSpacing: 0.5 }}>Mag 2026</div>
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
        ...
        <span style={{ fontSize: 12, fontWeight: 700, color: "var(--bi-ink-700)", textTransform: "uppercase", letterSpacing: 0.5 }}>
          Liste d'attesa · oggi
        </span>
      </div>
      {[
...
Object.assign(window, { AlertBar, Hero });

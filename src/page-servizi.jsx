...
const PSWidget = () => {
  ...
  return (
    <Section bg="var(--bi-surface)" id="pronto-soccorso">
      <SectionHeading
        eyebrow="Pronto Soccorso"
        title="Stato affollamento in tempo reale"
        subtitle="Consulta quanti pazienti sono in attesa prima di recarti al Pronto Soccorso."
      />
          ...
          >
            ...
            {ps.stale || ps.total === null ? (
              ...
              <>
                ...
                >
                  {Object.entries(ps.triage)
                    .filter(([, v]) => v > 0)
                    .map(([key, val]) => {
                      const tc = triageColors[key];
                      return (
                        <span
                          key={key}
                          style={{
                ...
                >
                  <Icon name="clock" size={12} /> Aggiornato {ps.updated}
                </div>
              </>
            )}
          </div>

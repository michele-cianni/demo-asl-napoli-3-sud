...
const Button = ({
  ...
  const variants = {
    primary:   { background: "var(--bi-primary)", color: "#fff", borderColor: "var(--bi-primary)" },
    warm:      { background: "var(--bi-warm)", color: "#fff", borderColor: "var(--bi-warm)" },
    outline:   { background: "transparent", color: "var(--bi-primary)", borderColor: "var(--bi-primary)" },
    ghost:     { background: "transparent", color: "var(--bi-primary)", borderColor: "transparent" },
    white:     { background: "#fff", color: "var(--bi-primary)", borderColor: "#fff" },
    outlineWhite: { background: "transparent", color: "#fff", borderColor: "rgba(255,255,255,0.8)" },
    subtle:    { background: "var(--bi-primary-050)", color: "var(--bi-primary-800)", borderColor: "transparent" },
  };
  const sizes = {
  ...
  if (as === "a" || href) return <a href={href || "#"} onClick={onClick} style={style}>{content}</a>;
...
const ArrowLink = ({ children, href = "#", color = "var(--bi-primary)" }) => (
  <a href={href} style={{
    color, fontWeight: 700, display: "inline-flex", alignItems: "center", gap: 6,
    borderBottom: "1px solid currentColor", paddingBottom: 2, textDecoration: "none",
  }}>
...
const Eyebrow = ({ children, color = "var(--bi-teal)" }) => (
  <div style={{
    color, fontWeight: 700, fontSize: 13, letterSpacing: 1.2,
    ...
    <div style={{ maxWidth: align === "center" ? 720 : 680 }}>
      ...
      {subtitle && (
        <p style={{
          ...
          color: "var(--bi-ink-500)", fontSize: 18, lineHeight: 1.55, maxWidth: 620,
        }}>{subtitle}</p>
      )}
    </div>
    {action}
...
Object.assign(window, { Button, Badge, ArrowLink, Section, Eyebrow, SectionHeading });

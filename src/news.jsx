      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: 24 }}>
        ...
        <article style={{
          ...
          <div className="placeholder-img" style={{
            ...
            fontSize: 11, color: "var(--bi-primary-800)",
          }}>
          ...
          <div style={{ padding: 32, flex: 1 }}>
            ...
            <h3 style={{
              fontFamily: "var(--ff-serif)", fontSize: 28, fontWeight: 500,
              lineHeight: 1.2, margin: "0 0 12px", color: "var(--bi-ink-900)",
              textWrap: "pretty",
            }}>
              {feat.title}
            </h3>
            <p style={{ color: "var(--bi-ink-500)", fontSize: 16, lineHeight: 1.6, margin: "0 0 20px" }}>
              {feat.desc}
            </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {rest.map((item, i) => (
            ...
            onMouseLeave={e => e.currentTarget.style.borderColor = "var(--bi-border)"}>
              ...
              <h4 style={{
                margin: 0, fontFamily: "var(--ff-serif)", fontSize: 18, fontWeight: 500,
                lineHeight: 1.25, color: "var(--bi-ink-900)",
              }}>{item.title}</h4>
              <p style={{ margin: 0, color: "var(--bi-ink-500)", fontSize: 13, lineHeight: 1.5 }}>
                {item.desc}
              </p>
            </a>
          ))}
...
const Facilities = () => {
  ...
  const presidi = [
    { name: "P.O. Santa Maria delle Grazie", city: "Pozzuoli", beds: 250, depts: 14, phone: "081 855 2111" },
    { name: "P.O. Santa Maria della Pietà",  city: "Nola",     beds: 180, depts: 12, phone: "081 310 5111" },
    { name: "P.O. San Leonardo",              city: "Castellammare", beds: 310, depts: 18, phone: "081 872 9111" },
    { name: "P.O. Anna Rizzoli",              city: "Ischia",   beds: 95,  depts: 8,  phone: "081 507 9111" },
    { name: "P.O. Boscotrecase",              city: "Boscotrecase", beds: 135, depts: 10, phone: "081 535 3111" },
    { name: "P.O. Maresca",                   city: "Torre del Greco", beds: 215, depts: 13, phone: "081 849 0111" },
  ];
  ...
  return (
    <Section bg="var(--bi-surface)" id="strutture">
      <SectionHeading
        ...
        action={<Button variant="outline" icon="location">Mappa interattiva</Button>}
      />
        ...
        {presidi.map((p, i) => (
          ...
          onMouseLeave={e => {
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{
                  fontFamily: "var(--ff-serif)", fontSize: 18, fontWeight: 500,
            ...
            <div style={{
              display: "flex", gap: 20,
              paddingTop: 16, borderTop: "1px solid var(--bi-border)",
              fontSize: 13,
            }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: 16, color: "var(--bi-ink-900)" }}>{p.beds}</div>
                <div style={{ color: "var(--bi-ink-500)", fontSize: 11, textTransform: "uppercase", letterSpacing: 0.5 }}>Posti letto</div>
              </div>
              <div>
                <div style={{ fontWeight: 700, fontSize: 16, color: "var(--bi-ink-900)" }}>{p.depts}</div>
                <div style={{ color: "var(--bi-ink-500)", fontSize: 11, textTransform: "uppercase", letterSpacing: 0.5 }}>Reparti</div>
              </div>
              <div style={{ flex: 1, textAlign: "right", alignSelf: "center" }}>
                <div style={{ fontSize: 13, color: "var(--bi-primary)", fontWeight: 600 }}>
...
Object.assign(window, { News, Facilities });

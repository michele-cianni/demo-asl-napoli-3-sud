    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <strong>Avviso:</strong> questo assistente fornisce solo
            informazioni di orientamento. Non fornisce consigli medici.{" "}
            <strong>In caso di emergenza, chiama il 118.</strong>
          </div>

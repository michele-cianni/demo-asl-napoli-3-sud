...
const Screening = () => {
  ...
  const tonesMap = {
    primary: { bg: "var(--bi-primary-050)", fg: "var(--bi-primary)", accent: "var(--bi-primary)" },
    teal:    { bg: "var(--bi-teal-100)", fg: "var(--bi-teal-700)", accent: "var(--bi-teal)" },
    warm:    { bg: "var(--bi-warm-100)", fg: "var(--bi-warm)", accent: "var(--bi-warm)" },
  };
  ...
  return (
    <Section bg="var(--bi-surface)" id="screening">
      <SectionHeading
        ...
        action={<Button variant="outline" iconRight="arrow-right">Prenota uno screening</Button>}
      />
          ...
          return (
            <article key={i} style={{
              ...
              <div style={{ position: "relative", zIndex: 1, flex: 1 }}>
                <h3 style={{
                  margin: "0 0 8px", fontFamily: "var(--ff-serif)",
                  fontSize: 22, fontWeight: 500, lineHeight: 1.2,
                  color: "var(--bi-ink-900)",
                }}>{p.title}</h3>
                <p style={{ margin: 0, color: "var(--bi-ink-500)", fontSize: 14, lineHeight: 1.55 }}>
                  {p.desc}
                </p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 11, color: "var(--bi-ink-500)", textTransform: "uppercase", letterSpacing: 0.6, fontWeight: 700 }}>
                    Target
                  </div>
                  <div style={{ fontSize: 14, fontWeight: 600, color: "var(--bi-ink-900)" }}>{p.target}</div>
                </div>
                <div>
                  <div style={{ fontSize: 11, color: "var(--bi-ink-500)", textTransform: "uppercase", letterSpacing: 0.6, fontWeight: 700 }}>
                    Frequenza
                  </div>
                  <div style={{ fontSize: 14, fontWeight: 600, color: "var(--bi-ink-900)" }}>{p.period}</div>
                </div>
              </div>
...
Object.assign(window, { Screening });
